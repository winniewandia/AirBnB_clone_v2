#!/usr/bin/python3
"""A script that starts a Flask web application and has 7 routes
and renders a template if variable is odd or even
"""
...
def number_odd_or_even(n):
    """renders html depending on wether n is even or odd

    Args:
        n (int): variable to be checked
